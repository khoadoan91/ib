...
export declare const MAX_SUPPORTED_SERVER_VERSION = MIN_SERVER_VER.PENDING_PRICE_REVISION;
...
export declare interface IBApi {
     ...
     * @see [[reqTickByTickData]]
     */
    on(event: EventName.tickByTickBidAsk, listener: (reqId: number, time: number, bidPrice: number, askPrice: number, bidSize: number, askSize: number, tickAttribBidAsk: unknown) => void): this;
    /**
